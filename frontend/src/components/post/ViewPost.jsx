...
import Header from '../default/HeaderComponent'

export default function ViewPost() {
    return (
        <>
            <Header heading='Man must explore, and this is exploration at its greatest' className='post-heading'>
                    ...
                    <Row className='gx-4 gx-lg-5 justify-content-center'>
                        <Col md={ 10 } lg={ 8 } xl={ 7 }>
                            ...
                            <p>There can be no thought of finishing for ‘aiming for the stars.’ Both figuratively and literally, it
                                is a task to occupy the generations. And no matter how much progress one makes, there is always the
                                thrill of just beginning.</p>
                            <blockquote className="blockquote">The dreams of yesterday are the hopes of today and the reality of
                            ...
                            {/* <a href="#!"><img className="img-fluid" src="/static/img/post-sample-image.jpg" alt="..." /></a> */ }
                            <span className="caption text-muted">To go places and do things that have never been done before – that’s
