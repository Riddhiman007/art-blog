          ...
          <div key="user-info" className="container border-r-2">
            ...
            <div key="nav-items" className="mt-8 h-full">
              <div className="mx-4 flex flex-col flex-wrap items-stretch gap-1 !p-0 [align-content:stretch]">
                      ...
                      <Link
                        href="/"
                        className="group mb-2 bg-slate-50 px-4 py-2 outline-transparent focus-within:bg-neutral-900 hover:z-30 hover:rounded-lg hover:bg-neutral-900 hover:shadow-lg hover:shadow-neutral-700"
                      >
                      ...
                      <Menu>
                        ...
                        >
                            ...
                            <Menu.Item
                              as={Link}
                              href="/"
                              className="side-item mx-3 mb-2 w-full text-left hover:rounded-lg hover:bg-neutral-900 hover:text-neutral-50"
                            >
